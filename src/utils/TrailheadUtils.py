...
class TrailheadUtils:
    ...
    XPATH_BADGES = '//*[@id="main-wrapper"]/div/div/div/div[1]/section/div[2]/div[2]/div/div[1]/div[2]'
    XPATH_POINTS = '//*[@id="main-wrapper"]/div/div/div/div[1]/section/div[2]/div[2]/div/div[2]/div[2]'
    XPATH_TRAILS = '//*[@id="main-wrapper"]/div/div/div/div[1]/section/div[2]/div[2]/div/div[3]/div[2]'
    XPATH_RANKS = '//*[@id="main-wrapper"]/div/div/div/div[1]/section/div[1]/a/img'
    XPATH_DROPDOWN = '//*[@id="main-wrapper"]/div/div/div/div[1]/div[1]/section/div[1]/button'
    XPATH_DROPDOWN_SUPERBADGES = '//*[@id="main-wrapper"]/div/div/div/div[1]/div[1]/section/div[1]/ul/li[1]/a'
    XPATH_SUPERBADGES = '//*[@id="main-wrapper"]/div/div/div/div[1]/div[1]/section/h2'
    XPATH_ABOUT_ME = '//*[@id="main-wrapper"]/div/div/div/div[1]/div[2]/section/form/div[1]/h2'
    XPATH_RELATIONSHIP = '//*[@id="main-wrapper"]/div/div/div/div[1]/div[2]/section/form/div[2]/div[6]/div/div/span'
    XPATH_COMPANY = '//*[@id="main-wrapper"]/div/div/div/div[1]/div[2]/section/form/div[2]/div[7]/div/div/span'
